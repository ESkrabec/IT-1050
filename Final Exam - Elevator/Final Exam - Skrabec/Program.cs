...
namespace Final_Exam___Skrabec
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool elevator1IsOverMaxCapacity = Convert.ToBoolean(elevator1.IsOverMaxCapacity());
            ...
            bool elevator2IsOverMaxCapacity = Convert.ToBoolean(elevator2.IsOverMaxCapacity());
        }
    }
}
